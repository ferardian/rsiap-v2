      ...
      <div class="hero-content">
        <div class="title-section">
          ...
          <div class="title-text">
            <h1>Berkas Komite PPI</h1>
            <p>Data Berkas Komite Pencegahan dan Pengendalian Infeksi Terdaftar RSIA Aisyiyah Pekajangan</p>
          </div>
        </div>
    ...
    <div class="card-modern">
      <div class="table-container">
        ...
        <div v-else class="empty-state">
          ...
          <p>Belum ada data Berkas Komite PPI yang terdaftar atau sesuai kriteria pencarian.</p>
...
// Import Modals
import PpiFormModal from './components/PpiFormModal.vue'
import PpiDetailModal from './components/PpiDetailModal.vue'
...
const loadData = async (page = 1) => {
  ...
  try {
    ...
    const response = await komitePpiService.search(searchQuery.value, pagination.value.per_page, page, filters)
    ...
    toast.error('Gagal memuat data Berkas Komite PPI')
  } finally {
    loading.value = false
  }
}
...
const executeDelete = async () => {
  ...
  try {
    ...
    await komitePpiService.delete(identifier)
