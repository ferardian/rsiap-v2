            ...
            <tr v-for="(item, index) in berkasList" :key="index" class="table-row-hover">
              ...
              <template v-else-if="activeTab === 'kredensial'">
                ...
                <td>
                  ...
                  <template v-if="item.sk && item.sk.status_approval === 'disetujui'">
                  ...
                  <template v-else-if="item.sk && item.sk.status_approval === 'pengajuan'">
                    <div class="fw-medium mb-1" style="font-size:12px; color:#92400e;">{{ item.sk.judul }}</div>
                    <div class="d-flex flex-wrap gap-1">
                      ...
                      <span class="badge" style="background:#f1f5f9; color:#64748b; font-weight:500; font-size:10px; border:1px solid #e2e8f0;">
                        <i class="fas fa-hashtag me-1"></i> No: {{ formatNomorSk(item.sk) }}
                      </span>
                    </div>
                  </template>
                  <!-- SK ditolak -->
                  <template v-else-if="item.sk && item.sk.status_approval === 'ditolak'">
                    <div class="fw-medium mb-1" style="font-size:12px; color:#991b1b;">{{ item.sk.judul }}</div>
              ...
              <td>
                <div class="action-buttons-cell justify-content-center">
                  ...
                  <template v-if="activeTab === 'kredensial' && item.sk?.status_approval === 'disetujui'">
