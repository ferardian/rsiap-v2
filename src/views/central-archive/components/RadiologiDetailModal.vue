    ...
    <div class="modal-content" @click.stop>
      <div class="modal-header">
        <h3 class="modal-title">
          <i class="fas fa-radiation text-blue-600"></i>
          Detail Berkas Radiologi
        </h3>
      ...
      <div class="modal-body" v-if="data">
        ...
        <div class="nomor-badge-container">
          <div class="badge-label">NOMOR BERKAS RADIOLOGI</div>
        ...
        <div class="detail-grid">
          ...
          <div class="detail-group">
            ...
            <div class="detail-value">
              <span class="badge-category">{{ data.prefix || 'RAD' }}</span>
            </div>
          </div>
