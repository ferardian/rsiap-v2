      ...
      <div class="hero-content">
        <div class="title-section">
          ...
          <div class="title-text">
            <h1>Berkas Komite PMKP</h1>
            <p>Data Berkas Komite Peningkatan Mutu dan Keselamatan Pasien Terdaftar RSIA Aisyiyah Pekajangan</p>
          </div>
        </div>
    ...
    <div class="card-modern">
      <div class="table-container">
        ...
        <div v-else class="empty-state">
          ...
          <p>Belum ada data Berkas Komite PMKP yang terdaftar atau sesuai kriteria pencarian.</p>
...
import { komitePmkpService } from '@/services/komitePmkpService'
import debounce from 'lodash/debounce'
import { format } from 'date-fns'

// Import Modals
import PmkpFormModal from './components/PmkpFormModal.vue'
import PmkpDetailModal from './components/PmkpDetailModal.vue'
...
const loadData = async (page = 1) => {
  ...
  try {
    ...
    const response = await komitePmkpService.search(searchQuery.value, pagination.value.per_page, page, filters)
    ...
    toast.error('Gagal memuat data Berkas Komite PMKP')
  } finally {
    loading.value = false
  }
}
...
const formatNomorSurat = (berkas) => {
  ...
  try {
    ...
    const prefix = berkas.prefix || 'KOM-PMKP'
    return `${no}/${prefix}/${tglPattern}`
  } catch (e) {
    return `${berkas.nomor}/${berkas.prefix || 'KOM-PMKP'}`
  }
}
...
const executeDelete = async () => {
  ...
  try {
    ...
    await komitePmkpService.delete(identifier)
