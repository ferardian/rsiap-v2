    ...
    <div class="page-header">
      <div class="header-content">
        <div class="header-text">
          <h1 class="page-title">💼 Approval Lembur</h1>
          <p class="page-subtitle">Setujui, pantau, dan kelola pengajuan lembur pegawai</p>
        </div>
...
const activeTab = ref('pending_mgr') // pending_mgr, pending_sdi, approved, rejected
...
const canApprove = (item) => {
  ...
  if (item.status === 'ACC1') {
    // SDI approval phase: only allowed for admins/SDI (non-dept-locked)
    return !isDeptLocked.value
  }
  return false
}
