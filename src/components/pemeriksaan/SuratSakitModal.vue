<template>
  <div v-if="visible" class="surat-sakit-modal-overlay" @click.self="close">
    <div class="modal-content-custom border-0 shadow-2xl animate__animated animate__zoomIn animate__faster" 
         style="width: 100%; max-width: 640px; height: auto; max-height: 85vh; border-radius: 20px; overflow: hidden; background: #fafafa; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); display: flex; flex-direction: column;">
      ...
      <div v-if="!isLoading" class="modal-footer-custom py-2.5 px-4 d-flex justify-content-between align-items-center border-top" 
        ...
        <div class="d-flex align-items-center gap-2">
          ...
          >
            <i class="fas fa-print me-1.5"></i> Cetak Surat
          </button>
